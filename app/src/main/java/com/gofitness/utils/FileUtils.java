...
//        if (TextUtils.isEmpty(type) || "null".equals(type)) type = "png";
    ...
    /**
     * 获取 Muscle 图片 Assets 真实地址
     */
    public static String getMuscleImageAssetsURL(String fileName) {
        return getAssetsURL("Muscle" + File.separator + fileName + ".png");
    }
     ...
     * 获取 Muscle 图片
     */
    public static Bitmap getMuscleImage(Context context, String fileName) {
        return getImageFromAssets(context, "Muscle", fileName);
    }
